...
describe("ReplyController", () => {
    ...
    describe("getAllReplies", () => {
        describe("when getAllReplies is called", () => {
            let replies: Reply[]
    ...
    describe("createReply", () => {
        describe("when createReply is called", () => {
            let reply: Reply
    ...
    describe("updateReply", () => {
        describe("when updateReply is called", () => {
            let reply: Reply
            ...
            test("then it should call updateReply on the replyService", () => {
                expect(replyService.updateReply).toBeCalledWith(
                    ReplyStub({})._id,
                    {
                        content: "hello this is a new content",
                        reqUserId: RequestStub().user.userId,
    ...
    describe("deleteReply", () => {
        describe("when deleteReply is called", () => {
            let reply: Reply
    ...
    describe("likeReply", () => {
        describe("when likeReply is called", () => {
            let reply: Reply
    ...
    describe("unlikeReply", () => {
        describe("when unlikeReply is called", () => {
            let reply: Reply
